...
self.addEventListener("fetch", (event: FetchEvent) => {
  ...
  if (url.pathname === "/markdown") {
    const markdownContent = "# Hello, from a Deno Service Worker!";
    let htmlContent = marked(markdownContent); // Use the npm package to parse markdown
    ...
    event.respondWith(
      new Response("Hello from your Deno Service Worker!", {
